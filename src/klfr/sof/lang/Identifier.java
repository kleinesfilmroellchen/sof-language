...
public class Identifier implements Stackable {
	...
	public boolean equals(Object other) {
		return Identifier.class.isAssignableFrom(other.getClass())
				? ((Identifier) other).value.equals(value)
				: false;
	}
	...
	public int hashCode() {
		// change this from the string hashcode to not get hashtable collisions when strings are attempted to be used as keys
