...
impl NativeFunction {
	pub fn call<'gc>(&self, stack: &Stack<'gc>, mc: &Mutation<'gc>, span: SourceSpan) -> Result<(), Error> {
		if let Some(result) = match self {
			NativeFunction::Args1(function) => {
				let argument = stack.pop(mc, span)?;
				function(argument)
			},
			NativeFunction::Args2(function) => {
				let argument2 = stack.pop(mc, span)?;
				let argument1 = stack.pop(mc, span)?;
				function(argument1, argument2)
			},
			NativeFunction::Args3(function) => {
				let argument3 = stack.pop(mc, span)?;
				let argument2 = stack.pop(mc, span)?;
				let argument1 = stack.pop(mc, span)?;
				function(argument1, argument2, argument3)
			},
			NativeFunction::Args4(function) => {
				let argument4 = stack.pop(mc, span)?;
				let argument3 = stack.pop(mc, span)?;
				let argument2 = stack.pop(mc, span)?;
				let argument1 = stack.pop(mc, span)?;
			...
			NativeFunction::Args5(function) => {
				let argument5 = stack.pop(mc, span)?;
				let argument4 = stack.pop(mc, span)?;
				let argument3 = stack.pop(mc, span)?;
				let argument2 = stack.pop(mc, span)?;
				let argument1 = stack.pop(mc, span)?;
